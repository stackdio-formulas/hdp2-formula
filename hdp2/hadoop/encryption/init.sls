...
/etc/hadoop/conf/ca/private/cakey.pem:
  file:
    ...
    - mode: 400
    - makedirs: true
    - contents_pillar: hdp2:encryption:ca_key
    - require:
...
/etc/hadoop/conf/ca/certs/cacert.pem:
  file:
    ...
    - mode: 400
    - makedirs: true
    - contents_pillar: hdp2:encryption:ca_cert
    - require:
      - file: /etc/hadoop/conf/ca
...
{% if 'hdp2.hadoop.client' not in grains.roles %}
