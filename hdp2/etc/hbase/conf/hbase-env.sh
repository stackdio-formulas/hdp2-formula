...
export HBASE_HEAPSIZE="{{ pillar.hdp2.hbase.master_max_heap }}"
{% elif 'hdp2.hbase.regionserver' in grains.roles %}
export HBASE_HEAPSIZE="{{ pillar.hdp2.hbase.region_max_heap }}"
{% endif %}
